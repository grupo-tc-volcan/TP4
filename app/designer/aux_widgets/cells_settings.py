...
class Ui_CellsSettings(object):
    def setupUi(self, CellsSettings):
        ...
        self.cell_components.setDragEnabled(False)
        self.cell_components.setDragDropOverwriteMode(False)
        self.cell_components.setDragDropMode(QtWidgets.QAbstractItemView.NoDragDrop)
        self.cell_components.setDefaultDropAction(QtCore.Qt.IgnoreAction)
        ...
        self.cell_sensitivities.setProperty("showDropIndicator", True)
        self.cell_sensitivities.setDragEnabled(False)
        self.cell_sensitivities.setDragDropOverwriteMode(False)
        self.cell_sensitivities.setDragDropMode(QtWidgets.QAbstractItemView.NoDragDrop)
        self.cell_sensitivities.setDefaultDropAction(QtCore.Qt.IgnoreAction)
