...
class Ui_CellsSettings(object):
    ...
    def retranslateUi(self, CellsSettings):
        ...
        self.cell_selector.setItemText(0, _translate("CellsSettings", "Compensated Integrator"))
        self.cell_selector.setItemText(1, _translate("CellsSettings", "Compensated Derivator"))
        self.cell_selector.setItemText(2, _translate("CellsSettings", "Sallen-Key"))
        ...
        self.cell_selector.setItemText(8, _translate("CellsSettings", "Fleischer-Tow"))
        self.label_2.setText(_translate("CellsSettings", "<html><head/><body><p><span style=\" font-weight:600;\">Parameters</span></p></body></html>"))
