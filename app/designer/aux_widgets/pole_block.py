...
class Ui_PoleBlock(object):
    def setupUi(self, PoleBlock):
        ...
        PoleBlock.resize(230, 124)
        PoleBlock.setMaximumSize(QtCore.QSize(270, 16777215))
        ...
        self.gridLayout_2.addWidget(self.q_val, 1, 1, 1, 1)
    ...
    def retranslateUi(self, PoleBlock):
        ...
        self.label_3.setText(_translate("PoleBlock", "<html><head/><body><p align=\"right\"><span style=\" font-size:10pt; font-weight:600;\">f</span><span style=\" font-size:10pt; font-weight:600; vertical-align:sub;\">p</span><span style=\" font-size:10pt; font-weight:600;\">:</span></p></body></html>"))
        self.label.setText(_translate("PoleBlock", "<html><head/><body><p align=\"right\"><span style=\" font-size:10pt; font-weight:600;\">n:</span></p></body></html>"))
        ...
        self.label_4.setText(_translate("PoleBlock", "<html><head/><body><p align=\"right\"><span style=\" font-size:10pt; font-weight:600;\">Q:</span></p></body></html>"))
