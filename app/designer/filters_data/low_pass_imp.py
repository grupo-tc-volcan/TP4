...
from app.designer.filters_data.low_pass import Ui_LowPassData
...
class LowPassData(QtWid.QWidget, Ui_LowPassData):

    def __init__(self, *args, **kwargs):
        super(LowPassData, self).__init__(*args, **kwargs)
        self.setupUi(self)
    ...
    def on_change(self):
        ...
        self.approximators[self.approx_index].type = 'low-pass'
