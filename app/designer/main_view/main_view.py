...
from app.designer.aux_widgets.stages import StagesList, PolesList, ZerosList
...
class Ui_MainView(object):
    def setupUi(self, MainView):
        ...
        self.poles_list = PolesList(self.tab_stages)
        ...
        self.poles_list.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.poles_list.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.poles_list.setResizeMode(QtWidgets.QListView.Adjust)
        self.poles_list.setObjectName("poles_list")
        self.gridLayout_16.addWidget(self.poles_list, 1, 0, 4, 2)
        self.zeros_list = ZerosList(self.tab_stages)
        ...
        self.zeros_list.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.zeros_list.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.zeros_list.setResizeMode(QtWidgets.QListView.Adjust)
        self.zeros_list.setObjectName("zeros_list")
        self.gridLayout_16.addWidget(self.zeros_list, 1, 2, 4, 2)
        ...
        self.gridLayout_16.addWidget(self.stages_list, 5, 0, 1, 15)
        self.label_71 = QtWidgets.QLabel(self.tab_stages)
        self.label_71.setObjectName("label_71")
        self.gridLayout_16.addWidget(self.label_71, 0, 2, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.stages_toolbar, 4, 4, 1, 8)
        ...
        self.gridLayout_16.addWidget(self.stage_plot, 0, 4, 4, 11)
        ...
        self.gridLayout_16.addWidget(self.label_82, 6, 11, 1, 1)
        self.v_min = QtWidgets.QDoubleSpinBox(self.tab_stages)
        self.v_min.setMaximumSize(QtCore.QSize(66, 16777215))
        self.v_min.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.v_min.setDecimals(2)
        self.v_min.setObjectName("v_min")
        self.gridLayout_16.addWidget(self.v_min, 6, 10, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_16.addItem(spacerItem, 6, 4, 1, 5)
        self.proceed_to_design = QtWidgets.QPushButton(self.tab_stages)
        self.proceed_to_design.setObjectName("proceed_to_design")
        self.gridLayout_16.addWidget(self.proceed_to_design, 6, 2, 1, 2)
        ...
        self.stages_list_cells.setDragEnabled(False)
        self.stages_list_cells.setDragDropOverwriteMode(True)
        self.stages_list_cells.setDragDropMode(QtWidgets.QAbstractItemView.NoDragDrop)
        self.stages_list_cells.setDefaultDropAction(QtCore.Qt.IgnoreAction)
        self.stages_list_cells.setFlow(QtWidgets.QListView.LeftToRight)
        self.stages_list_cells.setObjectName("stages_list_cells")
        self.gridLayout_17.addWidget(self.stages_list_cells, 1, 0, 1, 3)
        self.stage_circuit = QtWidgets.QLabel(self.tab_cells)
        self.stage_circuit.setObjectName("stage_circuit")
        self.gridLayout_17.addWidget(self.stage_circuit, 0, 0, 1, 2)
    ...
    def retranslateUi(self, MainView):
        ...
        self.dynamic_range.setText(_translate("MainView", "<html><head/><body><p><span style=\" font-size:10pt;\">...</span></p></body></html>"))
        self.v_max.setSuffix(_translate("MainView", "V"))
        ...
        self.v_min.setSuffix(_translate("MainView", "V"))
        self.proceed_to_design.setText(_translate("MainView", "Accept and proceed to design"))
        self.process_tabs.setTabText(self.process_tabs.indexOf(self.tab_stages), _translate("MainView", "Stages"))
        self.stage_circuit.setText(_translate("MainView", "<html><head/><body><p align=\"center\">Stage circuit</p></body></html>"))
