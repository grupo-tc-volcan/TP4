...
def generate_by_stages(stages: int, filename: str):
	file = open("{}.html".format(filename), "w")
	html_content = ""
	for index, stage in enumerate(stages):
		html_content += generate_html_content(index + 1, stage.get_name(), stage.get_type(), stage.get_circuit(), stage.get_components(), stage.get_sensitivities())
